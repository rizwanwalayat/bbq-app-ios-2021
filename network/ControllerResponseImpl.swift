...
//                    emptyDict = ["network_list" : String(item[0])]
                ...
                {
                    let keyValue = value
                    var keyvaluepart = keyValue.split(separator: "=", maxSplits: 1, omittingEmptySubsequences: true)
...
//        RSAHelper().loadPubKey(key: rsa!)
    ...
    func getF11Values() -> [String:String] {
        ...
        {
            var list = self.payload.split(separator: ",", maxSplits: Int.max , omittingEmptySubsequences: true)
//            print(list)
